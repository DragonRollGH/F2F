...
.van-calendar__selected-day {
    ...
    border-radius: var(--calendar-selected-day-radius, 4px);
    color: var(--calendar-selected-day-color, #000);
...
.heart {
    position: relative;
    width: var(--calendar-heart-size, 24px);
    height: var(--calendar-heart-size, 24px);
    top: var(--calendar-top-offset, 4px);
    background-color: var(--calendar-heart-color, #eeced1);
...
.heart:before {
    bottom: 0px;
    left: var(--calendar-heart-side-offset, -12px);
}
.heart:after {
    top: var(--calendar-heart-side-offset, -12px);
    right: 0px;
}
